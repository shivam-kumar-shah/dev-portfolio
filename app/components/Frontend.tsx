  ...
  return (
    <>
      <img
        ...
        } fixed left-1/2 z-[45] max-h-[90vh] max-w-[90vh] -translate-x-1/2 transition-all duration-500 ease-in-out  sm:-translate-y-1/2 sm:translate-x-0`}
      />

      <section className='sticky top-0 z-[40] h-screen w-screen overflow-hidden border-t-2 border-textPrimary bg-backgroundBackend px-4 pt-24'>
        <div className='mx-auto flex h-full  w-screen max-w-6xl flex-col text-center'>
          ...
          <div className='grid grow grid-cols-2 gap-x-4'>
            ...
            <div className='pt-24 text-left text-2xl'>
